...
## Dégâts importants %%à confirmer%%
Cette règle optionnelle permet à une créature d'être plus facilement abattue par des dégâts massifs.

Lorsqu'une créature subit des dégâts d'une seule source égaux ou supérieurs à la moitié de son maximum de points de vie, elle doit réussir un jet de sauvegarde de Constitution DC 15 ou subir un effet aléatoire déterminé par un jet sur la table Choc des systèmes. Par exemple, une créature dont le maximum de points de vie est de 30 doit réussir ce jet de sauvegarde de Constitution si elle subit 15 points de dégâts ou plus d'une seule source.

### Choc systémique
|  d10 |                                                           Effet                                                          |
|:----:|:-------------------------------------------------------------------------------------------------------------------------:|
| 1 | La créature tombe à 0 point de vie.                                            |
| 2-3 | La créature tombe à 0 point de vie mais reste stable.                                     |
| 4-5 | La créature est étourdie jusqu'à la fin de son prochain tour.                                  |
| 6-7 | La créature ne peut pas réagir et a un désavantage sur les jets d'attaque et les tests de capacité jusqu'à la fin de son prochain tour. |
| 8-10 | La créature ne peut pas réagir jusqu'à la fin de son prochain tour.                             |
